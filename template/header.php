...
<title>E-Library Info - <?php echo $titlepage ?></title>
</head>
...
<!-- logo -->
<div id="logo">
  <a href="./admin/" class="btn btn-success btn-flat pull-right">Admin Login <i class="fa fa-sign-in"></i></a>
	<a href="./index.php"><img src="./images/logo.png" width="350px" style="padding:10px;" class="img-responsive"></a>
</div>
<!-- nav bar-->
